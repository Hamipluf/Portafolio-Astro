  ...
  return (
    <Block className="col-span-12 flex flex-col items-center  gap-4 md:col-span-3">
      ...
      <div className="flex items-start">
        <img className="w-5 h-5 mx-2" src="/assets/argentina.png" alt="Bandera Argentina" />
        <p className="text-center text-sm lg:text-lg text-zinc-400">{i18n.HERO.LOCATION}</p>
